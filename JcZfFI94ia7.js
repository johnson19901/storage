...
!function () {
    ...
    const t = function (e, t) {
        ...
        encodeByteArray(e, t) {
            ...
            for (let t = 0; t < e.length; t += 3) {
                const s = e[t], r = t + 1 < e.length, o = r ? e[t + 1] : 0, a = t + 2 < e.length, h = a ? e[t + 2] : 0,
                    l = s >> 2, c = (3 & s) << 4 | o >> 4;
                let u = (15 & o) << 2 | h >> 6, d = 63 & h;
        ...
        decodeStringToByteArray(e, t) {
            ...
            for (let t = 0; t < e.length;) {
                const s = n[e.charAt(t++)], o = t < e.length ? n[e.charAt(t)] : 0;
                ++t;
                const a = t < e.length ? n[e.charAt(t)] : 64;
                ++t;
                const h = t < e.length ? n[e.charAt(t)] : 64;
                if (++t, null == s || null == o || null == a || null == h) throw new r;
                const l = s << 2 | o >> 4;
                if (i.push(l), 64 !== a) {
                    const e = o << 4 & 240 | a >> 2;
                    if (i.push(e), 64 !== h) {
    ...
    class f extends Error {
        constructor(e, t, n) {
            super(t), this.code = e, this.customData = n, this.name = "FirebaseError", Object.setPrototypeOf(this, f.prototype), Error.captureStackTrace && Error.captureStackTrace(this, g.prototype.create)
        }
    }
    ...
    class g {
        ...
        create(e, ...t) {
            const n = t[0] || {}, i = `${this.service}/${e}`, s = this.errors[e], r = s ? function (e, t) {
                return e.replace(m, ((e, n) => {
                    const i = t[n];
                    return null != i ? String(i) : `<${n}?>`
                }))
            }(s, n) : "Error", o = `${this.serviceName}: ${r} (${i}).`;
            return new f(i, o, n)
        }
    }
    ...
    const C = function (e) {
        ...
        try {
            const r = e.split(".");
            t = y(h(r[0]) || ""), n = y(h(r[1]) || ""), s = r[2], i = n.d || {}, delete n.d
        } catch (e) {
        }
    ...
    class k {
        ...
        compress_(e, t) {
            ...
            let i, s, r = this.chain_[0], o = this.chain_[1], a = this.chain_[2], h = this.chain_[3],
                l = this.chain_[4];
            for (let e = 0; e < 80; e++) {
    ...
    class x {
        ...
        getOrInitializeService({instanceIdentifier: e, options: t = {}}) {
            ...
            if (!n && this.component && (n = this.component.instanceFactory(this.container, {
                instanceIdentifier: (i = e, i === D ? void 0 : i),
                options: t
    ...
    const L = {debug: M.DEBUG, verbose: M.VERBOSE, info: M.INFO, warn: M.WARN, error: M.ERROR, silent: M.SILENT},
        F = M.INFO, q = {[M.DEBUG]: "log", [M.VERBOSE]: "log", [M.INFO]: "info", [M.WARN]: "warn", [M.ERROR]: "error"},
        W = (e, t, ...n) => {
    ...
    class U {
        constructor(e) {
            this.name = e, this._logLevel = F, this._logHandler = W, this._userLogHandler = null, O.push(this)
        }
    ...
    const B = (e, t) => t.some((t => e instanceof t));
    let j, H;
    const z = new WeakMap, V = new WeakMap, $ = new WeakMap, K = new WeakMap, G = new WeakMap;
    let Y = {
        get(e, t, n) {
    ...
    function Q(e) {
        return "function" == typeof e ? (t = e) !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype ? (H || (H = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function (...e) {
            return t.apply(X(this), e), J(z.get(this))
        } : function (...e) {
            return J(t.apply(X(this), e))
        } : function (e, ...n) {
            const i = t.call(X(this), e, ...n);
            return $.set(i, e.sort ? e.sort() : [e]), J(i)
            ...
            V.set(e, t)
        }(e), B(e, j || (j = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])) ? new Proxy(e, Y) : e);
        var t
    }
    ...
    function J(e) {
        ...
        const t = Q(e);
        return t !== e && (K.set(e, t), G.set(t, e)), t
    }

    const X = e => G.get(e), Z = ["get", "getKey", "getAll", "getAllKeys", "count"],
        ee = ["put", "add", "delete", "clear"], te = new Map;

    function ne(e, t) {
        if (!(e instanceof IDBDatabase) || t in e || "string" != typeof t) return;
        if (te.get(t)) return te.get(t);
        const n = t.replace(/FromIndex$/, ""), i = t !== n, s = ee.includes(n);
        if (!(n in (i ? IDBIndex : IDBObjectStore).prototype) || !s && !Z.includes(n)) return;
    ...
    var ie;
    ie = Y, Y = {...ie, get: (e, t, n) => ne(e, t) || ie.get(e, t, n), has: (e, t) => !!ne(e, t) || ie.has(e, t)};
    ...
    const re = "@firebase/app", oe = "0.9.25", ae = new U("@firebase/app"), he = "[DEFAULT]", le = {
        [re]: "fire-core",
    ...
    }, ce = new Map, ue = new Map;

    function de(e, t) {
        try {
            e.container.addComponent(t)
        } catch (n) {
            ae.debug(`Component ${t.name} failed to register with FirebaseApp ${e.name}`, n)
        }
    }

    function pe(e) {
        const t = e.name;
        if (ue.has(t)) return ae.debug(`There were multiple attempts to register component ${t}.`), !1;
        ue.set(t, e);
        for (const t of ce.values()) de(t, e);
        return !0
    }

    const _e = new g("app", "Firebase", {
    ...
    class fe {
        constructor(e, t, n) {
            this._isDeleted = !1, this._options = Object.assign({}, e), this._config = Object.assign({}, t), this._name = t.name, this._automaticDataCollectionEnabled = t.automaticDataCollectionEnabled, this._container = n, this.container.addComponent(new P("app", (() => this), "PUBLIC"))
        }
        ...
        checkDestroyed() {
            if (this.isDeleted) throw _e.create("app-deleted", {appName: this._name})
        }
    }
    ...
    function ge(e, t = {}) {
        ...
        const i = Object.assign({name: he, automaticDataCollectionEnabled: !1}, t), s = i.name;
        if ("string" != typeof s || !s) throw _e.create("bad-app-name", {appName: String(s)});
        if (n || (n = d()), !n) throw _e.create("no-options");
        const r = ce.get(s);
        if (r) {
            if (E(n, r.options) && E(i, r.config)) return r;
            throw _e.create("duplicate-app", {appName: s})
        }
        const o = new A(s);
        for (const e of ue.values()) o.addComponent(e);
        const a = new fe(n, i, o);
        return ce.set(s, a), a
    }

    function me(e, t, n) {
        var i;
        let s = null !== (i = le[e]) && void 0 !== i ? i : e;
        n && (s += `-${n}`);
        const r = s.match(/\s|\//), o = t.match(/\s|\//);
        if (r || o) {
            const e = [`Unable to register library "${s}" with version "${t}":`];
            return r && e.push(`library name "${s}" contains illegal characters (whitespace or "/")`), r && o && e.push("and"), o && e.push(`version name "${t}" contains illegal characters (whitespace or "/")`), void ae.warn(e.join(" "))
        }
        pe(new P(`${s}-version`, (() => ({library: s, version: t})), "VERSION"))
    }

    const ye = "firebase-heartbeat-database", ve = 1, Ce = "firebase-heartbeat-store";
    let we = null;

    function be() {
        return we || (we = function (e, t, {blocked: n, upgrade: i, blocking: s, terminated: r} = {}) {
            const o = indexedDB.open(e, t), a = J(o);
            return i && o.addEventListener("upgradeneeded", (e => {
                i(J(o.result), e.oldVersion, e.newVersion, J(o.transaction), e)
            ...
            upgrade: (e, t) => {
                0 === t && e.createObjectStore(Ce)
            }
        }).catch((e => {
            throw _e.create("idb-open", {originalErrorMessage: e.message})
        }))), we
    }

    async function Ie(e, t) {
        try {
            const n = (await be()).transaction(Ce, "readwrite"), i = n.objectStore(Ce);
            await i.put(t, Te(e)), await n.done
        } catch (e) {
            if (e instanceof f) ae.warn(e.message); else {
                const t = _e.create("idb-set", {originalErrorMessage: null == e ? void 0 : e.message});
                ae.warn(t.message)
            }
        }
    }
    ...
    class Ee {
        constructor(e) {
            ...
            this._storage = new ke(t), this._heartbeatsCachePromise = this._storage.read().then((e => (this._heartbeatsCache = e, e)))
        }

        async triggerHeartbeat() {
            var e, t;
            const n = this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(), i = Se();
        ...
        async getHeartbeatsHeader() {
            ...
            const t = Se(), {heartbeatsToSend: n, unsentEntries: i} = function (e, t = 1024) {
                const n = [];
                let i = e.slice();
                for (const s of e) {
                    const e = n.find((e => e.agent === s.agent));
                    if (e) {
                        if (e.dates.push(s.date), Ne(n) > t) {
                            e.dates.pop();
                            break
                        }
                    } else if (n.push({agent: s.agent, dates: [s.date]}), Ne(n) > t) {
                        n.pop();
                        break
                    }
                    i = i.slice(1)
            ...
            }(this._heartbeatsCache.heartbeats), s = a(JSON.stringify({version: 2, heartbeats: n}));
        ...
        async read() {
            if (await this._canUseIndexedDBPromise) {
                const e = await async function (e) {
                    try {
                        const t = await be();
                        return await t.transaction(Ce).objectStore(Ce).get(Te(e))
                    } catch (e) {
                        if (e instanceof f) ae.warn(e.message); else {
                            const t = _e.create("idb-get", {originalErrorMessage: null == e ? void 0 : e.message});
                            ae.warn(t.message)
                        }
                    }
                }(this.app);
    ...
    pe(new P("platform-logger", (e => new se(e)), "PRIVATE")), pe(new P("heartbeat", (e => new Ee(e)), "PRIVATE")), me(re, oe, ""), me(re, oe, "esm2017"), me("fire-js", ""), me("firebase", "10.7.1", "app");
    const Re = "@firebase/database", Pe = "1.0.2";
    let De = "";
    ...
    const Oe = function (e) {
        try {
            if ("undefined" != typeof window && void 0 !== window[e]) {
                const t = window[e];
                return t.setItem("firebase:sentinel", "cache"), t.removeItem("firebase:sentinel"), new xe(t)
            }
        } catch (e) {
        }
        return new Ae
    }, Me = Oe("localStorage"), Le = Oe("sessionStorage"), Fe = new U("@firebase/database"), qe = function () {
        let e = 1;
        return function () {
            return e++
        }
        ...
        const n = function (e) {
            ...
            for (let s = 0; s < e.length; s++) {
                ...
                if (r >= 55296 && r <= 56319) {
                    const n = r - 55296;
                    s++, t(s < e.length, "Surrogate pair missing trail surrogate."), r = 65536 + (n << 10) + (e.charCodeAt(s) - 56320)
                }
        ...
        for (let n = 0; n < e.length; n++) {
            const i = e[n];
            Array.isArray(i) || i && "object" == typeof i && "number" == typeof i.length ? t += Ue.apply(null, i) : t += "object" == typeof i ? v(i) : i, t += " "
        }
        return t
    };
    let Be = null, je = !0;
    const He = function (...e) {
        if (!0 === je && (je = !1, null === Be && !0 === Le.get("logging_enabled") && (n = !0, t(!i || !0 === n || !1 === n, "Can't turn on custom loggers persistently."), !0 === n ? (Fe.logLevel = M.VERBOSE, Be = Fe.log.bind(Fe), i && Le.set("logging_enabled", !0)) : "function" == typeof n ? Be = n : (Be = null, Le.remove("logging_enabled")))), Be) {
            const t = Ue.apply(null, e);
            Be(t)
        }
        var n, i
    }, ze = function (e) {
        ...
        const t = "FIREBASE INTERNAL ERROR: " + Ue(...e);
        Fe.error(t)
    }, $e = function (...e) {
        const t = `FIREBASE FATAL ERROR: ${Ue(...e)}`;
        throw Fe.error(t), new Error(t)
    }, Ke = function (...e) {
        const t = "FIREBASE WARNING: " + Ue(...e);
        Fe.warn(t)
    }, Ge = function (e) {
        return "number" == typeof e && (e != e || e === Number.POSITIVE_INFINITY || e === Number.NEGATIVE_INFINITY)
    }, Ye = "[MIN_NAME]", Qe = "[MAX_NAME]", Je = function (e, t) {
        if (e === t) return 0;
        if (e === Ye || t === Qe) return -1;
        if (t === Ye || e === Qe) return 1;
        {
            const n = rt(e), i = rt(t);
        ...
        t.sort();
        let n = "{";
        for (let i = 0; i < t.length; i++) 0 !== i && (n += ","), n += v(t[i]), n += ":", n += et(e[t[i]]);
        return n += "}", n
    }, tt = function (e, t) {
        const n = e.length;
        if (n <= t) return [e];
    ...
    const it = function (e) {
        t(!Ge(e), "Invalid JSON number");
        let n, i, s, r, o;
        0 === e ? (i = 0, s = 0, n = 1 / e == -1 / 0 ? 1 : 0) : (n = e < 0, (e = Math.abs(e)) >= Math.pow(2, -1022) ? (r = Math.min(Math.floor(Math.log(e) / Math.LN2), 1023), i = r + 1023, s = Math.round(e * Math.pow(2, 52 - r) - Math.pow(2, 52))) : (i = 0, s = Math.round(e / Math.pow(2, -1074))));
        const a = [];
    ...
    }, st = new RegExp("^-?(0*)\\d{1,10}$"), rt = function (e) {
        if (st.test(e)) {
            const t = Number(e);
        ...
        try {
            ...
            setTimeout((() => {
                const t = e.stack || "";
                throw Ke("Exception was thrown by user callback.", t), e
            }), Math.floor(0))
        }
    }, at = function (e, t) {
    ...
    class ht {
        ...
        notifyForInvalidToken() {
            Ke(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`)
        }
    }
    ...
    class lt {
        ...
        getToken(e) {
            return this.auth_ ? this.auth_.getToken(e).catch((e => e && "auth/token-not-initialized" === e.code ? (He("Got auth/token-not-initialized error.  Treating as null token."), null) : Promise.reject(e))) : new Promise(((t, n) => {
                setTimeout((() => {
    ...
    ct.OWNER = "owner";
    const ut = "5", dt = /(console\.firebase|firebase-console-\w+\.corp|firebase\.corp)\.google\.com/, pt = "ac",
        _t = "websocket", ft = "long_polling";

    class gt {
        constructor(e, t, n, i, s = !1, r = "", o = !1, a = !1) {
            this.secure = t, this.namespace = n, this.webSocketOnly = i, this.nodeAdmin = s, this.persistenceKey = r, this.includeNamespaceInQueryParams = o, this.isUsingEmulator = a, this._host = e.toLowerCase(), this._domain = this._host.substr(this._host.indexOf(".") + 1), this.internalHost = Me.get("host:" + e) || this._host
        }
    ...
    function mt(e, n, i) {
        let s;
        if (t("string" == typeof n, "typeof type must == string"), t("object" == typeof i, "typeof params must == object"), n === _t) s = (e.secure ? "wss://" : "ws://") + e.internalHost + "/.ws?"; else {
            if (n !== ft) throw new Error("Unknown connection type: " + n);
    ...
    class bt {
        ...
        handleResponse(e, t) {
            for (this.pendingResponses[e] = t; this.pendingResponses[this.currentResponseNum];) {
                ...
                for (let t = 0; t < e.length; ++t) e[t] && ot((() => {
                    this.onMessage_(e[t])
                }));
    ...
    class Tt {
        constructor(e, t, n, i, s, r, o) {
            this.connId = e, this.repoInfo = t, this.applicationId = n, this.appCheckToken = i, this.authToken = s, this.transportSessionId = r, this.lastSessionId = o, this.bytesSent = 0, this.bytesReceived = 0, this.everConnected_ = !1, this.log_ = ze(e), this.stats_ = wt(t), this.urlFn = e => (this.appCheckToken && (e[pt] = this.appCheckToken), mt(t, ft, e))
        }

        open(e, t) {
            this.curSegmentNum = 0, this.onDisconnect_ = t, this.myPacketOrderer = new bt(e), this.isClosed_ = !1, this.connectTimeoutTimer_ = setTimeout((() => {
                ...
                this.scriptTagHolder = new Et(((...e) => {
                    const [t, n, i, s, r] = e;
                    if (this.incrementIncomingBytes_(e), this.scriptTagHolder) if (this.connectTimeoutTimer_ && (clearTimeout(this.connectTimeoutTimer_), this.connectTimeoutTimer_ = null), this.everConnected_ = !0, t === It) this.id = n, this.password = i; else {
                ...
                const e = {};
                e[It] = "t", e.ser = Math.floor(1e8 * Math.random()), this.scriptTagHolder.uniqueCallbackIdentifier && (e.cb = this.scriptTagHolder.uniqueCallbackIdentifier), e.v = ut, this.transportSessionId && (e.s = this.transportSessionId), this.lastSessionId && (e.ls = this.lastSessionId), this.applicationId && (e.p = this.applicationId), this.appCheckToken && (e[pt] = this.appCheckToken), "undefined" != typeof location && location.hostname && dt.test(location.hostname) && (e.r = "f");
        ...
        static isAvailable() {
            return !(!Tt.forceAllow_ && (Tt.forceDisallow_ || "undefined" == typeof document || null == document.createElement || "object" == typeof window && window.chrome && window.chrome.extension && !/^chrome/.test(window.location.href) || "object" == typeof Windows && "object" == typeof Windows.UI))
        }
    ...
    class Et {
        constructor(e, t, n, i) {
            ...
            {
                this.uniqueCallbackIdentifier = qe(), window["pLPCommand" + this.uniqueCallbackIdentifier] = e, window["pRTLPCB" + this.uniqueCallbackIdentifier] = t, this.myIFrame = Et.createIFrame_();
                let n = "";
                ...
                try {
                    ...
                    He("frame writing exception"), e.stack && He(e.stack), He(e)
                }
            }
        }
    ...
    let St = null;
    "undefined" != typeof MozWebSocket ? St = MozWebSocket : "undefined" != typeof WebSocket && (St = WebSocket);

    class kt {
        constructor(e, t, n, i, s, r, o) {
            this.connId = e, this.applicationId = n, this.appCheckToken = i, this.authToken = s, this.keepaliveTimer = null, this.frames = null, this.totalFrames = 0, this.bytesSent = 0, this.bytesReceived = 0, this.log_ = ze(this.connId), this.stats_ = wt(t), this.connURL = kt.connectionURL_(t, r, o, i, n), this.nodeAdmin = t.nodeAdmin
        }

        static connectionURL_(e, t, n, i, s) {
            const r = {};
            return r.v = ut, "undefined" != typeof location && location.hostname && dt.test(location.hostname) && (r.r = "f"), t && (r.s = t), n && (r.ls = n), i && (r[pt] = i), s && (r.p = s), mt(e, _t, r)
        }
        ...
        open(e, t) {
            ...
            try {
                let e;
                0, this.mySock = new St(this.connURL, [], e)
            } catch (e) {
        ...
        static isAvailable() {
            ...
            return !e && null !== St && !kt.forceDisallow_
        }

        static previouslyFailed() {
            return Me.isInMemoryStorage || !0 === Me.get("previous_websocket_failure")
        }
        ...
        extractFrameCount_(e) {
            if (t(null === this.frames, "We already have a frame buffer"), e.length <= 6) {
                const t = Number(e);
    ...
    kt.responsesRequiredToBeHealthy = 2, kt.healthyTimeout = 3e4;
    ...
    class Nt {
        ...
        initTransports_(e) {
            const t = kt && kt.isAvailable();
            let n = t && !kt.previouslyFailed();
            if (e.webSocketOnly && (t || Ke("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), n = !0), n) this.transports_ = [kt]; else {
                const e = this.transports_ = [];
                for (const t of Nt.ALL_TRANSPORTS) t && t.isAvailable() && e.push(t);
                Nt.globalTransportInitialized_ = !0
            }
        }
    ...
    class Rt {
        ...
        onControl_(e) {
            ...
            if ("d" in e) {
                ...
                } else "s" === t ? this.onConnectionShutdown_(n) : "r" === t ? this.onReset_(n) : "e" === t ? Ve("Server Error: " + n) : "o" === t ? (this.log_("got pong on primary."), this.onPrimaryResponse_(), this.sendPingOnPrimaryIfNecessary_()) : Ve("Unknown control packet command: " + t)
            }
        }

        onHandshake_(e) {
            const t = e.ts, n = e.v, i = e.h;
            this.sessionId = e.s, this.repoInfo_.host = i, 0 === this.state_ && (this.conn_.start(), this.onConnectionEstablished_(this.conn_, t), ut !== n && Ke("Protocol version mismatch detected"), this.tryStartUpgrade_())
        }
        ...
        startUpgrade_(e) {
            ...
            this.secondaryConn_.open(t, n), at((() => {
        ...
        onConnectionEstablished_(e, t) {
            this.log_("Realtime connection established."), this.conn_ = e, this.state_ = 1, this.onReady_ && (this.onReady_(t, this.sessionId), this.onReady_ = null), 0 === this.primaryResponsesRequired_ ? (this.log_("Primary connection is healthy."), this.isHealthy_ = !0) : at((() => {
        ...
        onConnectionLost_(e) {
            this.conn_ = null, e || 0 !== this.state_ ? 1 === this.state_ && this.log_("Realtime connection lost.") : (this.log_("Realtime connection failed."), this.repoInfo_.isCacheableHost() && (Me.remove("host:" + this.repoInfo_.host), this.repoInfo_.internalHost = this.repoInfo_.host)), this.close()
        }
    ...
    class Dt {
        constructor(e) {
            this.allowedEvents_ = e, this.listeners_ = {}, t(Array.isArray(e) && e.length > 0, "Requires a non-empty array")
        }
        ...
        validateEventType_(e) {
            t(this.allowedEvents_.find((t => t === e)), "Unknown event: " + e)
        }
    }

    class xt extends Dt {
        constructor() {
            super(["online"]), this.online_ = !0, "undefined" == typeof window || void 0 === window.addEventListener || _() || (window.addEventListener("online", (() => {
        ...
        getInitialEvent(e) {
            return t("online" === e, "Unknown event type: " + e), [this.online_]
        }
    ...
    function Ft(e) {
        let t = e.pieceNum_;
        return t < e.pieces_.length && t++, new At(e.pieces_, t)
    }
    ...
    function Bt(e, t) {
        ...
        if (t instanceof At) for (let e = t.pieceNum_; e < t.pieces_.length; e++) n.push(t.pieces_[e]); else {
            const e = t.split("/");
    ...
    class $t {
        constructor(e, t) {
            this.errorPrefix_ = t, this.parts_ = Wt(e, 0), this.byteLength_ = Math.max(1, this.parts_.length);
            for (let e = 0; e < this.parts_.length; e++) this.byteLength_ += N(this.parts_[e]);
            Kt(this)
        }
    }
    ...
    class Yt extends Dt {
        ...
        getInitialEvent(e) {
            return t("visible" === e, "Unknown event type: " + e), [this.visible_]
        }
    }
    ...
    class Jt extends Pt {
        ...
        listen(e, n, i, s) {
            ...
            this.log_("Listen called for " + o + " " + r), this.listens.has(o) || this.listens.set(o, new Map), t(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "listen() called for non-default but complete query"), t(!this.listens.get(o).has(r), "listen() called twice for same path/queryId.");
            const a = {onComplete: s, hashFn: n, query: e, tag: i};
        ...
        sendListen_(e) {
            ...
            e.tag && (s.q = t._queryObject, s.t = e.tag), s.h = e.hashFn(), this.sendRequest("q", s, (s => {
                const r = s.d, o = s.s;
                Jt.warnOnListenWarnings_(r, t), (this.listens.get(n) && this.listens.get(n).get(i)) === e && (this.log_("listen response", s), "ok" !== o && this.removeListen_(n, i), e.onComplete && e.onComplete(o, r))
            }))
        }
        ...
        static warnOnListenWarnings_(e, t) {
            if (e && "object" == typeof e && w(e, "w")) {
                ...
                if (Array.isArray(n) && ~n.indexOf("no_index")) {
                    ...
                    Ke(`Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding ${e} at ${n} to your security rules for better performance.`)
                }
            }
        }
        ...
        unlisten(e, n) {
            ...
            this.log_("Unlisten called for " + i + " " + s), t(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "unlisten() called for non-default but complete query"), this.removeListen_(i, s) && this.connected_ && this.sendUnlisten_(i, s, e._queryObject, n)
        }
        ...
        sendPut_(e) {
            const t = this.outstandingPuts_[e].action, n = this.outstandingPuts_[e].request,
        ...
        onDataPush_(e, t) {
            this.log_("handleServerMessage", e, t), "d" === e ? this.onDataUpdate_(t.p, t.d, !1, t.t) : "m" === e ? this.onDataUpdate_(t.p, t.d, !0, t.t) : "c" === e ? this.onListenRevoked_(t.p, t.q) : "ac" === e ? this.onAuthRevoked_(t.s, t.d) : "apc" === e ? this.onAppCheckRevoked_(t.s, t.d) : "sd" === e ? this.onSecurityDebugPacket_(t) : Ve("Unrecognized action received from server: " + v(e) + "\nAre you using the latest client?")
        }
        ...
        scheduleConnect_(e) {
            t(!this.realtime_, "Scheduling a connect when we're already connected/ing?"), this.establishConnectionTimer_ && clearTimeout(this.establishConnectionTimer_), this.establishConnectionTimer_ = setTimeout((() => {
        ...
        onVisible_(e) {
            e && !this.visible_ && this.reconnectDelay_ === this.maxReconnectDelay_ && (this.log_("Window became visible.  Reducing delay."), this.reconnectDelay_ = Qt, this.realtime_ || this.scheduleConnect_(0)), this.visible_ = e
        }

        onOnline_(e) {
            e ? (this.log_("Browser went online."), this.reconnectDelay_ = Qt, this.realtime_ || this.scheduleConnect_(0)) : (this.log_("Browser went offline.  Killing connection."), this.realtime_ && this.realtime_.close())
        }
        ...
        async establishConnection_() {
            if (this.shouldReconnect_()) {
                ...
                const e = this.onDataMessage_.bind(this), n = this.onReady_.bind(this),
                    i = this.onRealtimeDisconnect_.bind(this), s = this.id + ":" + Jt.nextConnectionId_++,
                    r = this.lastSessionId;
                let o = !1, a = null;
                const h = function () {
                    a ? a.close() : (o = !0, i())
                }, l = function (e) {
                    t(a, "sendRequest call when we're not connected not allowed."), a.sendRequest(e)
                };
                this.realtime_ = {close: h, sendRequest: l};
                const c = this.forceTokenRefresh_;
                this.forceTokenRefresh_ = !1;
                try {
                    const [t, h] = await Promise.all([this.authTokenProvider_.getToken(c), this.appCheckTokenProvider_.getToken(c)]);
                    o ? He("getToken() completed but was canceled") : (He("getToken() completed. Creating connection."), this.authToken_ = t && t.accessToken, this.appCheckToken_ = h && h.token, a = new Rt(s, this.repoInfo_, this.applicationId_, this.appCheckToken_, this.authToken_, e, n, i, (e => {
                        Ke(e + " (" + this.repoInfo_.toString() + ")"), this.interrupt("server_kill")
                    }), r))
                } catch (e) {
                    this.log_("Failed to get token: " + e), o || (this.repoInfo_.nodeAdmin && Ke(e), h())
                }
            }
        }
        ...
        resume(e) {
            He("Resuming connection for reason: " + e), delete this.interruptReasons_[e], I(this.interruptReasons_) && (this.reconnectDelay_ = Qt, this.realtime_ || this.scheduleConnect_(0))
        }
        ...
        onAuthRevoked_(e, t) {
            He("Auth token revoked: " + e + "/" + t), this.authToken_ = null, this.forceTokenRefresh_ = !0, this.realtime_.close(), "invalid_token" !== e && "permission_denied" !== e || (this.invalidAuthTokenCount_++, this.invalidAuthTokenCount_ >= 3 && (this.reconnectDelay_ = 3e4, this.authTokenProvider_.notifyForInvalidToken()))
        }

        onAppCheckRevoked_(e, t) {
            He("App check token revoked: " + e + "/" + t), this.appCheckToken_ = null, this.forceTokenRefresh_ = !0, "invalid_token" !== e && "permission_denied" !== e || (this.invalidAppCheckTokenCount_++, this.invalidAppCheckTokenCount_ >= 3 && this.appCheckTokenProvider_.notifyForInvalidToken())
        }
        ...
        sendConnectStats_() {
            const e = {};
            let t = "js";
            e["sdk." + t + "." + De.replace(/\./g, "-")] = 1, _() ? e["framework.cordova"] = 1 : "object" == typeof navigator && "ReactNative" === navigator.product && (e["framework.reactnative"] = 1), this.reportStats(e)
        }

        shouldReconnect_() {
            const e = xt.getInstance().currentlyOnline();
    ...
    class Zt {
        ...
        indexedValueChanged(e, t) {
            const n = new Xt(Ye, e), i = new Xt(Ye, t);
    ...
    class tn extends Zt {
        ...
        compare(e, t) {
            return Je(e.name, t.name)
        }

        isDefinedOn(e) {
            throw n("KeyIndex.isDefinedOn not expected to be called.")
        }
        ...
        makePost(e, n) {
            return t("string" == typeof e, "KeyIndex indexValue must always be a string."), new Xt(e, en)
        }
    ...
    const cn = function (e) {
        return "number" == typeof e ? "number:" + it(e) : "string:" + e
    }, un = function (e) {
        if (e.isLeafNode()) {
            const n = e.val();
            t("string" == typeof n || "number" == typeof n || "object" == typeof n && w(n, ".sv"), "Priority must be a string or number.")
        } else t(e === ln || e.isEmpty(), "priority of unexpected type.");
        t(e === ln || e.getPriority().isEmpty(), "Priority nodes can't have a priority of their own.")
    };
    let dn, pn, _n;

    class fn {
        constructor(e, n = fn.__childrenNodeConstructor.EMPTY_NODE) {
            this.value_ = e, this.priorityNode_ = n, this.lazyHash_ = null, t(void 0 !== this.value_ && null !== this.value_, "LeafNode shouldn't be created with null/undefined value."), un(this.priorityNode_)
        }
        ...
        updatePriority(e) {
            return new fn(this.value_, e)
        }

        getImmediateChild(e) {
            return ".priority" === e ? this.priorityNode_ : fn.__childrenNodeConstructor.EMPTY_NODE
        }

        getChild(e) {
            return jt(e) ? this : ".priority" === Mt(e) ? this.priorityNode_ : fn.__childrenNodeConstructor.EMPTY_NODE
        }
        ...
        updateImmediateChild(e, t) {
            return ".priority" === e ? this.updatePriority(t) : t.isEmpty() && ".priority" !== e ? this : fn.__childrenNodeConstructor.EMPTY_NODE.updateImmediateChild(e, t).updatePriority(this.priorityNode_)
        }

        updateChild(e, n) {
            const i = Mt(e);
            return null === i ? n : n.isEmpty() && ".priority" !== i ? this : (t(".priority" !== i || 1 === Lt(e), ".priority must be the last token in a path"), this.updateImmediateChild(i, fn.__childrenNodeConstructor.EMPTY_NODE.updateChild(Ft(e), n)))
        }
        ...
        hash() {
            if (null === this.lazyHash_) {
                let e = "";
                this.priorityNode_.isEmpty() || (e += "priority:" + cn(this.priorityNode_.val()) + ":");
                const t = typeof this.value_;
                e += t + ":", e += "number" === t ? it(this.value_) : this.value_, this.lazyHash_ = We(e)
            }
        ...
        compareTo(e) {
            return e === fn.__childrenNodeConstructor.EMPTY_NODE ? 1 : e instanceof fn.__childrenNodeConstructor ? -1 : (t(e.isLeafNode(), "Unknown node type"), this.compareToLeafNode_(e))
        }

        compareToLeafNode_(e) {
            const n = typeof e.value_, i = typeof this.value_, s = fn.VALUE_TYPE_ORDER.indexOf(n),
                r = fn.VALUE_TYPE_ORDER.indexOf(i);
            return t(s >= 0, "Unknown leaf type: " + n), t(r >= 0, "Unknown leaf type: " + i), s === r ? "object" === i ? 0 : this.value_ < e.value_ ? -1 : this.value_ === e.value_ ? 0 : 1 : r - s
        }
    ...
    const gn = new class extends Zt {
        ...
        maxPost() {
            return new Xt(Qe, new fn("[PRIORITY-POST]", _n))
        }

        makePost(e, t) {
            const n = pn(e);
            return new Xt(t, new fn("[PRIORITY-POST]", n))
        }
    ...
    class yn {
        constructor(e) {
            var t;
            this.count = (t = e + 1, parseInt(Math.log(t) / mn, 10)), this.current_ = this.count - 1;
    ...
    const vn = function (e, t, n, i) {
        ...
        const s = function (t, i) {
            ...
            {
                const h = parseInt(r / 2, 10) + t, l = s(t, h), c = s(h + 1, i);
                return o = e[h], a = n ? n(o) : o, new rn(a, o.node, rn.BLACK, l, c)
            }
        }, r = function (t) {
            ...
            const a = function (t, i) {
                const r = o - t, a = o;
                o -= t;
                const l = s(r + 1, a), c = e[r], u = n ? n(c) : c;
                h(new rn(u, c.node, i, null, l))
            }, h = function (e) {
    ...
    class bn {
        ...
        static get Default() {
            return t(wn && gn, "ChildrenNode.ts has not been loaded"), Cn = Cn || new bn({".priority": wn}, {".priority": gn}), Cn
        }
        ...
        addIndex(e, n) {
            t(e !== nn, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
            const i = [];
            let s = !1;
            const r = n.getIterator(Xt.Wrap);
            let o, a = r.getNext();
            for (; a;) s = s || e.isDefinedOn(a.node), i.push(a), a = r.getNext();
            o = s ? vn(i, e.getCompare()) : wn;
            const h = e.toString(), l = Object.assign({}, this.indexSet_);
            l[h] = e;
            const c = Object.assign({}, this.indexes_);
            return c[h] = o, new bn(c, l)
        }

        addToIndexes(e, n) {
            const i = T(this.indexes_, ((i, s) => {
                const r = b(this.indexSet_, s);
                if (t(r, "Missing index implementation for " + s), i === wn) {
                    if (r.isDefinedOn(e.node)) {
                        const t = [], i = n.getIterator(Xt.Wrap);
                        let s = i.getNext();
                        for (; s;) s.name !== e.name && t.push(s), s = i.getNext();
                        return t.push(e), vn(t, r.getCompare())
                    }
                    return wn
                }
                {
                    ...
                    let s = i;
                    return t && (s = s.remove(new Xt(e.name, t))), s.insert(e, e.node)
                }
            }));
            return new bn(i, this.indexSet_)
        }

        removeFromIndexes(e, t) {
            const n = T(this.indexes_, (n => {
                if (n === wn) return n;
                {
            ...
            return new bn(n, this.indexSet_)
        }
    }
    ...
    class Tn {
        constructor(e, n, i) {
            this.children_ = e, this.priorityNode_ = n, this.indexMap_ = i, this.lazyHash_ = null, this.priorityNode_ && un(this.priorityNode_), this.children_.isEmpty() && t(!this.priorityNode_ || this.priorityNode_.isEmpty(), "An empty node cannot have a priority")
        }

        static get EMPTY_NODE() {
            return In || (In = new Tn(new on(hn), null, bn.Default))
        }
        ...
        getChild(e) {
            const t = Mt(e);
            return null === t ? this : this.getImmediateChild(t).getChild(Ft(e))
        }
        ...
        updateImmediateChild(e, n) {
            if (t(n, "We should always be passing snapshot nodes"), ".priority" === e) return this.updatePriority(n);
            {
                const t = new Xt(e, n);
                let i, s;
                n.isEmpty() ? (i = this.children_.remove(e), s = this.indexMap_.removeFromIndexes(t, this.children_)) : (i = this.children_.insert(e, n), s = this.indexMap_.addToIndexes(t, this.children_));
                const r = i.isEmpty() ? In : this.priorityNode_;
                return new Tn(i, r, s)
            }
        }
        ...
        updateChild(e, n) {
            ...
            if (null === i) return n;
            {
                t(".priority" !== Mt(e) || 1 === Lt(e), ".priority must be the last token in a path");
                const s = this.getImmediateChild(i).updateChild(Ft(e), n);
        ...
        hash() {
            if (null === this.lazyHash_) {
                let e = "";
                this.getPriority().isEmpty() || (e += "priority:" + cn(this.getPriority().val()) + ":"), this.forEachChild(gn, ((t, n) => {
                    const i = n.hash();
                    "" !== i && (e += ":" + t + ":" + i)
                })), this.lazyHash_ = "" === e ? "" : We(e)
            }
            return this.lazyHash_
        }
        ...
        compareTo(e) {
            return this.isEmpty() ? e.isEmpty() ? 0 : -1 : e.isLeafNode() || e.isEmpty() ? 1 : e === En ? -1 : 0
        }
            ...
            if (e.isLeafNode()) return !1;
            {
                ...
                if (this.getPriority().equals(t.getPriority())) {
                    if (this.children_.count() === t.children_.count()) {
                        const e = this.getIterator(gn), n = t.getIterator(gn);
    ...
    const En = new class extends Tn {
        constructor() {
            super(new on(hn), Tn.EMPTY_NODE, bn.Default)
        }
    ...
    Object.defineProperties(Xt, {
        MIN: {value: new Xt(Ye, Tn.EMPTY_NODE)},
        MAX: {value: new Xt(Qe, En)}
    }), tn.__EMPTY_NODE = Tn.EMPTY_NODE, fn.__childrenNodeConstructor = Tn, ln = En, _n = En;
    const Sn = !0;

    function kn(e, n = null) {
        if (null === e) return Tn.EMPTY_NODE;
        if ("object" == typeof e && ".priority" in e && (n = e[".priority"]), t(null === n || "string" == typeof n || "number" == typeof n || "object" == typeof n && ".sv" in n, "Invalid priority type found: " + typeof n), "object" == typeof e && ".value" in e && null !== e[".value"] && (e = e[".value"]), "object" != typeof e || ".sv" in e) return new fn(e, kn(n));
        if (e instanceof Array || !Sn) {
            let t = Tn.EMPTY_NODE;
            return nt(e, ((n, i) => {
                if (w(e, n) && "." !== n.substring(0, 1)) {
                    const e = kn(i);
                    !e.isLeafNode() && e.isEmpty() || (t = t.updateImmediateChild(n, e))
                }
            })), t.updatePriority(kn(n))
        }
        {
            const t = [];
            let i = !1;
            if (nt(e, ((e, n) => {
                if ("." !== e.substring(0, 1)) {
                    const s = kn(n);
                    s.isEmpty() || (i = i || !s.getPriority().isEmpty(), t.push(new Xt(e, s)))
                }
            })), 0 === t.length) return Tn.EMPTY_NODE;
            const s = vn(t, an, (e => e.name), hn);
            if (i) {
                const e = vn(t, gn.getCompare());
                return new Tn(s, kn(n), new bn({".priority": e}, {".priority": gn}))
            }
            return new Tn(s, kn(n), bn.Default)
        }
    }
    ...
    class Nn extends Zt {
        constructor(e) {
            super(), this.indexPath_ = e, t(!jt(e) && ".priority" !== Mt(e), "Can't create PathIndex with empty path or .priority key")
        }
        ...
        makePost(e, t) {
            const n = kn(e), i = Tn.EMPTY_NODE.updateChild(this.indexPath_, n);
            return new Xt(t, i)
        }

        maxPost() {
            const e = Tn.EMPTY_NODE.updateChild(this.indexPath_, En);
            return new Xt(Qe, e)
        }
    ...
    const Rn = new class extends Zt {
        compare(e, t) {
            const n = e.node.compareTo(t.node);
            return 0 === n ? Je(e.name, t.name) : n
        }
    ...
    class Dn {
        ...
        getIndexStartValue() {
            return t(this.startSet_, "Only valid if start has been set"), this.indexStartValue_
        }

        getIndexStartName() {
            return t(this.startSet_, "Only valid if start has been set"), this.startNameSet_ ? this.indexStartName_ : Ye
        }
        ...
        getIndexEndValue() {
            return t(this.endSet_, "Only valid if end has been set"), this.indexEndValue_
        }

        getIndexEndName() {
            return t(this.endSet_, "Only valid if end has been set"), this.endNameSet_ ? this.indexEndName_ : Qe
        }
        ...
        getLimit() {
            return t(this.limitSet_, "Only valid if limit has been set"), this.limit_
        }
    ...
    function xn(e) {
        ...
        let i;
        if (e.index_ === gn ? i = "$priority" : e.index_ === Rn ? i = "$value" : e.index_ === nn ? i = "$key" : (t(e.index_ instanceof Nn, "Unrecognized index type!"), i = e.index_.toString()), n.orderBy = v(i), e.startSet_) {
            const t = e.startAfterSet_ ? "startAfter" : "startAt";
            n[t] = v(e.indexStartValue_), e.startNameSet_ && (n[t] += "," + v(e.indexStartName_))
        }
        if (e.endSet_) {
            const t = e.endBeforeSet_ ? "endBefore" : "endAt";
            n[t] = v(e.indexEndValue_), e.endNameSet_ && (n[t] += "," + v(e.indexEndName_))
        }
        return e.limitSet_ && (e.isViewFromLeft() ? n.limitToFirst = e.limit_ : n.limitToLast = e.limit_), n
    }
    ...
    class On extends Pt {
        constructor(e, t, n, i) {
            super(), this.repoInfo_ = e, this.onDataUpdate_ = t, this.authTokenProvider_ = n, this.appCheckTokenProvider_ = i, this.log_ = ze("p:rest:"), this.listens_ = {}
        }
        ...
        static getListenId_(e, n) {
            return void 0 !== n ? "tag$" + n : (t(e._queryParams.isDefault(), "should have a tag if it's not a default query."), e._path.toString())
        }

        listen(e, t, n, i) {
            const s = e._path.toString();
            this.log_("Listen called for " + s + " " + e._queryIdentifier);
            const r = On.getListenId_(e, n), o = {};
            this.listens_[r] = o;
            const a = xn(e._queryParams);
            this.restRequest_(s + ".json", a, ((e, t) => {
                let a = t;
                if (404 === e && (a = null, e = null), null === e && this.onDataUpdate_(s, a, !1, n), b(this.listens_, r) === o) {
                    let t;
        ...
        unlisten(e, t) {
            const n = On.getListenId_(e, t);
            delete this.listens_[n]
        }

        get(e) {
            const t = xn(e._queryParams), n = e._path.toString(), i = new p;
                    ...
                    if (n && 4 === o.readyState) {
                        ...
                        if (o.status >= 200 && o.status < 300) {
                            try {
                                ...
                                Ke("Failed to parse JSON response for " + r + ": " + o.responseText)
                            }
                            n(null, e)
                        } else 401 !== o.status && 404 !== o.status && Ke("Got unsuccessful REST response for " + r + " Status: " + o.status), n(o.status);
                        n = null
                    }
    ...
    function Fn(e, t, n) {
        if (jt(t)) e.value = n, e.children.clear(); else if (null !== e.value) e.value = e.value.updateChild(t, n); else {
            const i = Mt(t);
            e.children.has(i) || e.children.set(i, Ln()), Fn(e.children.get(i), t = Ft(t), n)
        }
    }
    ...
    class Wn {
        ...
        get() {
            ...
            return this.last_ && nt(this.last_, ((e, n) => {
                t[e] = t[e] - n
            })), this.last_ = e, t
        }
    }
    ...
    class Un {
        constructor(e, t) {
            this.server_ = t, this.statsToReport_ = {}, this.statsListener_ = new Wn(e);
            const n = 1e4 + 2e4 * Math.random();
            at(this.reportStats_.bind(this), Math.floor(n))
        }
        ...
        reportStats_() {
            ...
            let n = !1;
            nt(e, ((e, i) => {
                i > 0 && w(this.statsToReport_, e) && (t[e] = i, n = !0)
            })), n && this.server_.reportStats(t), at(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5))
        }
    }
    ...
    class Hn {
        constructor(e, t, n) {
            this.path = e, this.affectedTree = t, this.revert = n, this.type = Bn.ACK_USER_WRITE, this.source = {
                fromUser: !0,
                fromServer: !1,
                queryId: null,
                tagged: !1
        ...
        operationForChild(e) {
            if (jt(this.path)) {
                if (null != this.affectedTree.value) return t(this.affectedTree.children.isEmpty(), "affectedTree should not have overlapping affected paths."), this;
                {
                    const t = this.affectedTree.subtree(new At(e));
                    return new Hn(Ot(), t, this.revert)
                }
            }
            return t(Mt(this.path) === e, "operationForChild called for unrelated child."), new Hn(Ft(this.path), this.affectedTree, this.revert)
        }
    }

    class zn {
        constructor(e, t, n) {
            this.source = e, this.path = t, this.snap = n, this.type = Bn.OVERWRITE
        }

        operationForChild(e) {
            return jt(this.path) ? new zn(this.source, Ot(), this.snap.getImmediateChild(e)) : new zn(this.source, Ft(this.path), this.snap)
        }
    }

    class Vn {
        constructor(e, t, n) {
            this.source = e, this.path = t, this.children = n, this.type = Bn.MERGE
        }

        operationForChild(e) {
            if (jt(this.path)) {
                const t = this.children.subtree(new At(e));
                return t.isEmpty() ? null : t.value ? new zn(this.source, Ot(), t.value) : new Vn(this.source, Ot(), t)
            }
            return t(Mt(this.path) === e, "Can't get a merge for a child not on the path of the operation"), new Vn(this.source, Ft(this.path), this.children)
        }
    ...
    function Kn(e, t, i, s, r, o) {
        const a = s.filter((e => e.type === i));
        a.sort(((t, i) => function (e, t, i) {
            if (null == t.childName || null == i.childName) throw n("Should only compare child_ events.");
            const s = new Xt(t.childName, t.snapshotNode), r = new Xt(i.childName, i.snapshotNode);
    ...
    function Yn(e, t, n, i) {
        return Gn(new $n(t, n, i), e.serverCache)
    }

    function Qn(e, t, n, i) {
        return Gn(e.eventCache, new $n(t, n, i))
    }
    ...
    class ei {
        constructor(e, t = (() => (Zn || (Zn = new on(Xe)), Zn))()) {
        ...
        findRootMostMatchingPathAndValue(e, t) {
            if (null != this.value && t(this.value)) return {path: Ot(), value: this.value};
            if (jt(e)) return null;
            {
                const n = Mt(e), i = this.children.get(n);
                if (null !== i) {
                    const s = i.findRootMostMatchingPathAndValue(Ft(e), t);
                    return null != s ? {path: Bt(new At(n), s.path), value: s.value} : null
                }
                return null
            }
        }
        ...
        subtree(e) {
            if (jt(e)) return this;
            {
                const t = Mt(e), n = this.children.get(t);
                return null !== n ? n.subtree(Ft(e)) : new ei(null)
            }
        }

        set(e, t) {
            if (jt(e)) return new ei(t, this.children);
            {
                const n = Mt(e), i = (this.children.get(n) || new ei(null)).set(Ft(e), t),
                    s = this.children.insert(n, i);
                return new ei(this.value, s)
            }
        }

        remove(e) {
            if (jt(e)) return this.children.isEmpty() ? new ei(null) : new ei(null, this.children);
            {
                const t = Mt(e), n = this.children.get(t);
                if (n) {
                    const i = n.remove(Ft(e));
                    let s;
                    return s = i.isEmpty() ? this.children.remove(t) : this.children.insert(t, i), null === this.value && s.isEmpty() ? new ei(null) : new ei(this.value, s)
                }
                return this
            }
        }
        ...
        setTree(e, t) {
            if (jt(e)) return t;
            {
                const n = Mt(e), i = (this.children.get(n) || new ei(null)).setTree(Ft(e), t);
                let s;
                return s = i.isEmpty() ? this.children.remove(n) : this.children.insert(n, i), new ei(this.value, s)
            }
        }
        ...
        findOnPath_(e, t, n) {
            ...
            if (jt(e)) return null;
            {
                const i = Mt(e), s = this.children.get(i);
                return s ? s.findOnPath_(Ft(e), Bt(t, i), n) : null
            }
        }
        ...
        foreachOnPath_(e, t, n) {
            if (jt(e)) return this;
            {
                ...
                const i = Mt(e), s = this.children.get(i);
                return s ? s.foreachOnPath_(Ft(e), Bt(t, i), n) : new ei(null)
            }
        }
    ...
    function ni(e, t, n) {
        if (jt(t)) return new ti(new ei(n));
        {
            ...
            if (null != i) {
                ...
                let r = i.value;
                const o = Ht(s, t);
                return r = r.updateChild(o, n), new ti(e.writeTree_.set(s, r))
            }
            {
                const i = new ei(n), s = e.writeTree_.setTree(t, i);
                return new ti(s)
            }
        }
    }
    ...
    function si(e, t) {
        if (jt(t)) return ti.empty();
        {
            const n = e.writeTree_.setTree(t, new ei(null));
            return new ti(n)
        }
    }
    ...
    function oi(e, t) {
        ...
        return null != n ? e.writeTree_.get(n.path).getChild(Ht(n.path, t)) : null
    }
    ...
    function hi(e, t) {
        ...
        {
            const n = oi(e, t);
            return new ti(null != n ? new ei(n) : e.writeTree_.subtree(t))
        }
    }
    ...
    function ui(e, n, i) {
        if (null != n.value) return i.updateChild(e, n.value);
        {
            ...
            return n.children.inorderTraversal(((n, r) => {
                ".priority" === n ? (t(null !== r.value, "Priority writes must always be leaf nodes"), s = r.value) : i = ui(Bt(e, n), r, i)
            })), i.getChild(e).isEmpty() || null === s || (i = i.updateChild(Bt(e, ".priority"), s)), i
        }
    }
    ...
    function pi(e, t) {
        ...
        for (const n in e.children) if (e.children.hasOwnProperty(n) && Vt(Bt(e.path, n), t)) return !0;
        return !1
    }
    ...
    function fi(e, t, i) {
        ...
        for (let r = 0; r < e.length; ++r) {
            ...
            if (t(o)) {
                const e = o.path;
                let t;
                if (o.snap) Vt(i, e) ? (t = Ht(i, e), s = ni(s, t, o.snap)) : Vt(e, i) && (t = Ht(e, i), s = ni(s, Ot(), o.snap.getChild(t))); else {
                    if (!o.children) throw n("WriteRecord should have .snap or .children");
                    if (Vt(i, e)) t = Ht(i, e), s = ii(s, t, o.children); else if (Vt(e, i)) if (t = Ht(e, i), jt(t)) s = ii(s, Ot(), o.children); else {
                        const e = b(o.children, Mt(t));
                        if (e) {
                            const n = e.getChild(Ft(t));
                            s = ni(s, Ot(), n)
                        }
                    }
                }
    ...
    function gi(e, t, n, i, s) {
        if (i || s) {
            const r = hi(e.visibleWrites, t);
            if (!s && li(r)) return n;
            if (s || null != n || ri(r, Ot())) {
                const r = function (e) {
                    return (e.visible || s) && (!i || !~i.indexOf(e.writeId)) && (Vt(e.path, t) || Vt(t, e.path))
                };
                return ci(fi(e.allWrites, r, t), n || Tn.EMPTY_NODE)
            }
            return null
        }
        {
            const i = oi(e.visibleWrites, t);
            if (null != i) return i;
            {
                const i = hi(e.visibleWrites, t);
                return li(i) ? n : null != n || ri(i, Ot()) ? ci(i, n || Tn.EMPTY_NODE) : null
            }
        }
    }
    ...
    function vi(e, n, i, s) {
        return function (e, n, i, s, r) {
            t(s || r, "Either existingEventSnap or existingServerSnap must exist");
            const o = Bt(n, i);
            if (ri(e.visibleWrites, o)) return null;
            {
                const t = hi(e.visibleWrites, o);
                return li(t) ? r.getChild(i) : ci(t, r.getChild(i))
            }
        }(e.writeTree, e.treePath, n, i, s)
    }

    function Ci(e, t) {
        return function (e, t) {
            return oi(e.visibleWrites, t)
        }(e.writeTree, Bt(e.treePath, t))
    }

    function wi(e, t, n) {
        return function (e, t, n, i) {
            const s = Bt(t, n), r = oi(e.visibleWrites, s);
    ...
    function bi(e, t) {
        return Ii(Bt(e.treePath, t), e.writeTree)
    }
    ...
    class Ti {
        ...
        trackChildChange(e) {
            const i = e.type, s = e.childName;
            t("child_added" === i || "child_changed" === i || "child_removed" === i, "Only child changes supported for tracking"), t(".priority" !== s, "Only non-priority child changes can be tracked.");
            const r = this.changeMap.get(s);
            if (r) {
                const t = r.type;
                if ("child_added" === i && "child_removed" === t) this.changeMap.set(s, Pn(s, e.snapshotNode, r.snapshotNode)); else if ("child_removed" === i && "child_added" === t) this.changeMap.delete(s); else if ("child_removed" === i && "child_changed" === t) this.changeMap.set(s, (o = s, {
                    type: "child_removed",
                    snapshotNode: r.oldSnap,
                    childName: o
                })); else if ("child_changed" === i && "child_added" === t) this.changeMap.set(s, function (e, t) {
                    return {type: "child_added", snapshotNode: t, childName: e}
                }(s, e.snapshotNode)); else {
                    if ("child_changed" !== i || "child_changed" !== t) throw n("Illegal combination of changes: " + e + " occurred after " + r);
                    this.changeMap.set(s, Pn(s, e.snapshotNode, r.oldSnap))
                }
    ...
    class Si {
        ...
        getCompleteChild(e) {
            ...
            {
                const t = null != this.optCompleteServerCache_ ? new $n(this.optCompleteServerCache_, !0, !1) : this.viewCache_.serverCache;
                return wi(this.writes_, e, t)
            }
        }

        getChildAfterChild(e, t, n) {
            const i = null != this.optCompleteServerCache_ ? this.optCompleteServerCache_ : Xn(this.viewCache_),
                s = function (e, t, n, i, s, r) {
                    return function (e, t, n, i, s, r, o) {
                        let a;
                        const h = hi(e.visibleWrites, t), l = oi(h, Ot());
                        if (null != l) a = l; else {
                            if (null == n) return [];
                            a = ci(h, n)
                        }
    ...
    function ki(e, n, i, s, r, o) {
        const a = n.eventCache;
        if (null != Ci(s, i)) return n;
        {
            let h, l;
            if (jt(i)) if (t(n.serverCache.isFullyInitialized(), "If change path is empty, we must have complete server data"), n.serverCache.isFiltered()) {
                const t = Xn(n), i = yi(s, t instanceof Tn ? t : Tn.EMPTY_NODE);
                h = e.filter.updateFullNode(n.eventCache.getNode(), i, o)
            } else {
                const t = mi(s, Xn(n));
                h = e.filter.updateFullNode(n.eventCache.getNode(), t, o)
            } else {
                const c = Mt(i);
                if (".priority" === c) {
                    t(1 === Lt(i), "Can't have a priority with additional path components");
                    const r = a.getNode();
                    ...
                    if (a.isCompleteForChild(c)) {
                        l = n.serverCache.getNode();
                        const e = vi(s, i, a.getNode(), l);
                        u = null != e ? a.getNode().getImmediateChild(c).updateChild(t, e) : a.getNode().getImmediateChild(c)
                    } else u = wi(s, c, n.serverCache);
                    h = null != u ? e.filter.updateChild(a.getNode(), c, u, t, r, o) : a.getNode()
                }
            }
            return Yn(n, h, a.isFullyInitialized() || jt(i), e.filter.filtersNodes())
        }
    }
    ...
    function Ni(e, t, n, i, s, r, o, a) {
        ...
        if (jt(n)) l = c.updateFullNode(h.getNode(), i, null); else if (c.filtersNodes() && !h.isFiltered()) {
            const e = h.getNode().updateChild(n, i);
            l = c.updateFullNode(h.getNode(), e, null)
        } else {
            const e = Mt(n);
            if (!h.isCompleteForPath(n) && Lt(n) > 1) return t;
            const s = Ft(n), r = h.getNode().getImmediateChild(e).updateChild(s, i);
            l = ".priority" === e ? c.updatePriority(h.getNode(), r) : c.updateChild(h.getNode(), e, r, s, Ei, null)
        }
        const u = Qn(t, l, h.isFullyInitialized() || jt(n), c.filtersNodes());
        return ki(e, u, n, s, new Si(s, u, r), a)
    }

    function Ri(e, t, n, i, s, r, o) {
        const a = t.eventCache;
        let h, l;
        const c = new Si(s, t, r);
        if (jt(n)) l = e.filter.updateFullNode(t.eventCache.getNode(), i, o), h = Yn(t, l, !0, e.filter.filtersNodes()); else {
            const s = Mt(n);
            if (".priority" === s) l = e.filter.updatePriority(t.eventCache.getNode(), i), h = Yn(t, l, a.isFullyInitialized(), a.isFiltered()); else {
                const r = Ft(n), l = a.getNode().getImmediateChild(s);
                let u;
                if (jt(r)) u = i; else {
                    const e = c.getCompleteChild(s);
                    u = null != e ? ".priority" === qt(r) && e.getChild(Ut(r)).isEmpty() ? e : e.updateChild(r, i) : Tn.EMPTY_NODE
                }
                h = l.equals(u) ? t : Yn(t, e.filter.updateChild(a.getNode(), s, u, r, c, o), a.isFullyInitialized(), e.filter.filtersNodes())
            }
        }
        return h
    }
    ...
    function xi(e, t, n, i, s, r, o, a) {
        if (t.serverCache.getNode().isEmpty() && !t.serverCache.isFullyInitialized()) return t;
        let h, l = t;
        h = jt(n) ? i : new ei(null).setTree(n, i);
        const c = t.serverCache.getNode();
        return h.children.inorderTraversal(((n, i) => {
            if (c.hasChild(n)) {
                const h = Di(0, t.serverCache.getNode().getImmediateChild(n), i);
                l = Ni(e, l, new At(n), h, s, r, o, a)
            }
    ...
    function Ai(e, t) {
        ...
        return n && (e.query._queryParams.loadsAllData() || !jt(t) && !n.getImmediateChild(Mt(t)).isEmpty()) ? n.getChild(t) : null
    }

    function Oi(e, i, s, r) {
        i.type === Bn.MERGE && null !== i.source.queryId && (t(Xn(e.viewCache_), "We should always have a full cache before handling merges"), t(Jn(e.viewCache_), "Missing event cache, even though we have a server cache"));
        const o = e.viewCache_, a = function (e, i, s, r, o) {
            const a = new Ti;
            let h, l;
            if (s.type === Bn.OVERWRITE) {
                const n = s;
                n.source.fromUser ? h = Ri(e, i, n.path, n.snap, r, o, a) : (t(n.source.fromServer, "Unknown source."), l = n.source.tagged || i.serverCache.isFiltered() && !jt(n.path), h = Ni(e, i, n.path, n.snap, r, o, l, a))
            } else if (s.type === Bn.MERGE) {
                const n = s;
                n.source.fromUser ? h = function (e, t, n, i, s, r, o) {
                    let a = t;
                    return i.foreach(((i, h) => {
                        const l = Bt(n, i);
                        Pi(t, Mt(l)) && (a = Ri(e, a, l, h, s, r, o))
                    })), i.foreach(((i, h) => {
                        const l = Bt(n, i);
                        Pi(t, Mt(l)) || (a = Ri(e, a, l, h, s, r, o))
                    })), a
                }(e, i, n.path, n.children, r, o, a) : (t(n.source.fromServer, "Unknown source."), l = n.source.tagged || i.serverCache.isFiltered(), h = xi(e, i, n.path, n.children, r, o, l, a))
            } else if (s.type === Bn.ACK_USER_WRITE) {
                const n = s;
                h = n.revert ? function (e, n, i, s, r, o) {
                    let a;
                    if (null != Ci(s, i)) return n;
                    {
                        const h = new Si(s, n, r), l = n.eventCache.getNode();
                        let c;
                        if (jt(i) || ".priority" === Mt(i)) {
                            let i;
                            if (n.serverCache.isFullyInitialized()) i = mi(s, Xn(n)); else {
                                const e = n.serverCache.getNode();
                                t(e instanceof Tn, "serverChildren would be complete if leaf node"), i = yi(s, e)
                            }
                            c = e.filter.updateFullNode(l, i, o)
                        } else {
                            const t = Mt(i);
                            let r = wi(s, t, n.serverCache);
                            null == r && n.serverCache.isCompleteForChild(t) && (r = l.getImmediateChild(t)), c = null != r ? e.filter.updateChild(l, t, r, Ft(i), h, o) : n.eventCache.getNode().hasChild(t) ? e.filter.updateChild(l, t, Tn.EMPTY_NODE, Ft(i), h, o) : l, c.isEmpty() && n.serverCache.isFullyInitialized() && (a = mi(s, Xn(n)), a.isLeafNode() && (c = e.filter.updateFullNode(c, a, o)))
                        }
                        return a = n.serverCache.isFullyInitialized() || null != Ci(s, Ot()), Yn(n, c, a, e.filter.filtersNodes())
                    }
                }(e, i, n.path, r, o, a) : function (e, t, n, i, s, r, o) {
                    if (null != Ci(s, n)) return t;
                    const a = t.serverCache.isFiltered(), h = t.serverCache;
                    if (null != i.value) {
                        if (jt(n) && h.isFullyInitialized() || h.isCompleteForPath(n)) return Ni(e, t, n, h.getNode().getChild(n), s, r, a, o);
                        if (jt(n)) {
                            let i = new ei(null);
                            return h.getNode().forEachChild(nn, ((e, t) => {
                                i = i.set(new At(e), t)
                            })), xi(e, t, n, i, s, r, a, o)
                        }
                        return t
                ...
                }(e, i, n.path, n.affectedTree, r, o, a)
            } else {
                if (s.type !== Bn.LISTEN_COMPLETE) throw n("Unknown operation type: " + s.type);
                h = function (e, t, n, i, s) {
                    const r = t.serverCache;
                    return ki(e, Qn(t, r.getNode(), r.isFullyInitialized() || jt(n), r.isFiltered()), n, i, Ei, s)
                }(e, i, s.path, r, a)
            }
            ...
            return function (e, t, n) {
                ...
                if (i.isFullyInitialized()) {
                    const s = i.getNode().isLeafNode() || i.getNode().isEmpty(), r = Jn(e);
                    (n.length > 0 || !e.eventCache.isFullyInitialized() || s && !i.getNode().equals(r) || !i.getNode().getPriority().equals(r.getPriority())) && n.push({
                        type: "value",
                        snapshotNode: Jn(t)
                    })
                }
            }(i, h, c), {viewCache: h, changes: c}
        }(e.processor_, o, i, s, r);
        var h, l;
        return h = e.processor_, l = a.viewCache, t(l.eventCache.getNode().isIndexed(h.filter.getIndex()), "Event snap not indexed"), t(l.serverCache.getNode().isIndexed(h.filter.getIndex()), "Server snap not indexed"), t(a.viewCache.serverCache.isFullyInitialized() || !o.serverCache.isFullyInitialized(), "Once a server snap is complete, it should never go back"), e.viewCache_ = a.viewCache, function (e, t, n, i) {
            ...
            return function (e, t, n, i) {
                ...
                })), Kn(e, s, "child_removed", t, i, n), Kn(e, s, "child_added", t, i, n), Kn(e, s, "child_moved", r, i, n), Kn(e, s, "child_changed", t, i, n), Kn(e, s, "value", t, i, n), s
            }(e.eventGenerator_, t, n, s)
        }(e, a.changes, a.viewCache.eventCache.getNode(), null)
    }
    ...
    function Fi(e, n, i, s) {
        ...
        if (null !== r) {
            ...
            return t(null != o, "SyncTree gave us an op for an invalid query."), Oi(o, n, i, s)
        }
        {
            let t = [];
            for (const r of e.views.values()) t = t.concat(Oi(r, n, i, s));
            return t
        }
    }
    ...
    function qi(e, t) {
        let n = null;
        for (const i of e.views.values()) n = n || Ai(i, t);
        return n
    }
    ...
    function Ui(e, n, i, s, r) {
        return function (e, n, i, s, r) {
            t(s > e.lastWriteId, "Stacking an older write on top of newer ones"), void 0 === r && (r = !0), e.allWrites.push({
                path: n,
                snap: i,
                writeId: s,
                visible: r
            }), r && (e.visibleWrites = ni(e.visibleWrites, n, i)), e.lastWriteId = s
        }(e.pendingWriteTree_, n, i, s, r), r ? zi(e, new zn({
            fromUser: !0,
            fromServer: !1,
            queryId: null,
            tagged: !1
    ...
    function Bi(e, n, i = !1) {
        ...
        if (function (e, n) {
            const i = e.allWrites.findIndex((e => e.writeId === n));
            t(i >= 0, "removeWrite called with nonexistent writeId.");
            const s = e.allWrites[i];
            e.allWrites.splice(i, 1);
            let r = s.visible, o = !1, a = e.allWrites.length - 1;
            for (; r && a >= 0;) {
                const t = e.allWrites[a];
                t.visible && (a >= i && pi(t, s.path) ? r = !1 : Vt(s.path, t.path) && (o = !0)), a--
            }
            return !!r && (o ? (function (e) {
                e.visibleWrites = fi(e.allWrites, _i, Ot()), e.allWrites.length > 0 ? e.lastWriteId = e.allWrites[e.allWrites.length - 1].writeId : e.lastWriteId = -1
            }(e), !0) : (s.snap ? e.visibleWrites = si(e.visibleWrites, s.path) : nt(s.children, (t => {
                e.visibleWrites = si(e.visibleWrites, Bt(s.path, t))
            })), !0))
        }(e.pendingWriteTree_, n)) {
            let t = new ei(null);
            return null != s.snap ? t = t.set(Ot(), !0) : nt(s.children, (e => {
                t = t.set(new At(e), !0)
            })), zi(e, new Hn(s.path, t, i))
        }
        return []
    }

    function ji(e, t, n) {
        return zi(e, new zn({fromUser: !1, fromServer: !0, queryId: null, tagged: !1}, t, n))
    }
    ...
    function zi(e, t) {
        return Vi(t, e.syncPointTree_, null, di(e.pendingWriteTree_, Ot()))
    }

    function Vi(e, t, n, i) {
        if (jt(e.path)) return $i(e, t, n, i);
        {
            const s = t.get(Ot());
            null == n && null != s && (n = qi(s, Ot()));
            let r = [];
            const o = Mt(e.path), a = e.operationForChild(o), h = t.children.get(o);
            if (h && a) {
                const e = n ? n.getImmediateChild(o) : null, t = bi(i, o);
                r = r.concat(Vi(a, h, e, t))
            }
            return s && (r = r.concat(Fi(s, e, i, n))), r
        }
    }
    ...
    function $i(e, t, n, i) {
        ...
        return t.children.inorderTraversal(((t, s) => {
            const o = n ? n.getImmediateChild(t) : null, a = bi(i, t), h = e.operationForChild(t);
            h && (r = r.concat($i(h, s, o, a)))
        })), s && (r = r.concat(Fi(s, e, i, n))), r
    }
    ...
    function Gi(e) {
        const n = e.indexOf("$");
        return t(-1 !== n && n < e.length - 1, "Bad queryKey."), {
            queryId: e.substr(n + 1),
            path: new At(e.substr(0, n))
        }
    }

    function Yi(e, n, i) {
        const s = e.syncPointTree_.get(n);
        return t(s, "Missing sync point for query tag that we're tracking"), Fi(s, i, di(e.pendingWriteTree_, n), null)
    }
    ...
    class Ji {
        ...
        getImmediateChild(e) {
            const t = Bt(this.path_, e);
            return new Ji(this.syncTree_, t)
        }

        node() {
            return Hi(this.syncTree_, this.path_)
        }
    }
    ...
    const Xi = function (e) {
        ...
        return e && "object" == typeof e ? (t(".sv" in e, "Unexpected leaf node or priority contents"), "string" == typeof e[".sv"] ? es(e[".sv"], n, i) : "object" == typeof e[".sv"] ? ts(e[".sv"], n) : void t(!1, "Unexpected server value: " + JSON.stringify(e, null, 2))) : e
    }, es = function (e, n, i) {
        if ("timestamp" === e) return i.timestamp;
        t(!1, "Unexpected server value: " + e)
    }, ts = function (e, n, i) {
        e.hasOwnProperty("increment") || t(!1, "Unexpected server value: " + JSON.stringify(e, null, 2));
        const s = e.increment;
        "number" != typeof s && t(!1, "Unexpected increment value: " + s);
        const r = n.node();
        if (t(null != r, "Expected ChildrenNode.EMPTY_NODE for nulls"), !r.isLeafNode()) return s;
        const o = r.getValue();
        return "number" != typeof o ? s : o + s
    }, ns = function (e, t, n, i) {
        return ss(t, new Ji(n, e), i)
    }, is = function (e, t, n) {
        return ss(e, new Qi(t), n)
    };

    function ss(e, t, n) {
        const i = e.getPriority().val(), s = Zi(i, t.getImmediateChild(".priority"), n);
        let r;
        if (e.isLeafNode()) {
            const i = e, r = Zi(i.getValue(), t, n);
            return r !== i.getValue() || s !== i.getPriority().val() ? new fn(r, kn(s)) : e
        }
        {
            const i = e;
            return r = i, s !== i.getPriority().val() && (r = r.updatePriority(new fn(s))), i.forEachChild(gn, ((e, i) => {
                const s = ss(i, t.getImmediateChild(e), n);
    ...
    function os(e, t) {
        let n = t instanceof At ? t : new At(t), i = e, s = Mt(n);
        for (; null !== s;) {
            const e = b(i.node.children, s) || {children: {}, childCount: 0};
            i = new rs(s, i, e), n = Ft(n), s = Mt(n)
        }
        return i
    }
    ...
    function ds(e) {
        return new At(null === e.parent ? e.name : ds(e.parent) + "/" + e.name)
    }

    function ps(e) {
        null !== e.parent && function (e, t, n) {
            const i = function (e) {
                return void 0 === as(e) && !ls(e)
            }(n), s = w(e.node.children, t);
            i && s ? (delete e.node.children[t], e.node.childCount--, ps(e)) : i || s || (e.node.children[t] = n.node, e.node.childCount++, ps(e))
        }(e.parent, e.name, e)
    }

    const _s = /[\[\].#$\/\u0000-\u001F\u007F]/, fs = /[\[\].#$\u0000-\u001F\u007F]/, gs = 10485760, ms = function (e) {
        return "string" == typeof e && 0 !== e.length && !_s.test(e)
    }, ys = function (e, t, n) {
        const i = n instanceof At ? new $t(n, e) : n;
        ...
        if (Ge(t)) throw new Error(e + "contains " + t.toString() + " " + Gt(i));
        if ("string" == typeof t && t.length > gs / 3 && N(t) > gs) throw new Error(e + "contains a string greater than " + gs + " utf8 bytes " + Gt(i) + " ('" + t.substring(0, 50) + "...')");
        if (t && "object" == typeof t) {
            let n = !1, s = !1;
            if (nt(t, ((t, r) => {
                if (".value" === t) n = !0; else if (".priority" !== t && ".sv" !== t && (s = !0, !ms(t))) throw new Error(e + " contains an invalid key (" + t + ") " + Gt(i) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
                var o, a;
                a = t, (o = i).parts_.length > 0 && (o.byteLength_ += 1), o.parts_.push(a), o.byteLength_ += N(a), Kt(o), ys(e, r, i), function (e) {
                    const t = e.parts_.pop();
                    e.byteLength_ -= N(t), e.parts_.length > 0 && (e.byteLength_ -= 1)
                }(i)
            })), n && s) throw new Error(e + ' contains ".value" child ' + Gt(i) + " in addition to actual children.")
        }
    }, vs = function (e, t) {
        const n = t.path.toString();
        if ("string" != typeof t.repoInfo.host || 0 === t.repoInfo.host.length || !ms(t.repoInfo.namespace) && "localhost" !== t.repoInfo.host.split(":")[0] || 0 !== n.length && !function (e) {
            return e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), function (e) {
                return "string" == typeof e && 0 !== e.length && !fs.test(e)
            }(e)
        }(n)) throw new Error(function (e, t) {
            return `${e} failed: ${t} argument `
        }(e, "url") + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".')
    };
    ...
    function ws(e, t, n) {
        (function (e, t) {
            ...
            for (let i = 0; i < t.length; i++) {
                ...
                null === n || zt(r, n.path) || (e.eventLists_.push(n), n = null), null === n && (n = {
                    events: [],
                    path: r
                }), n.events.push(s)
            }
            ...
            for (let i = 0; i < e.eventLists_.length; i++) {
                ...
                s && (t(s.path) ? (bs(e.eventLists_[i]), e.eventLists_[i] = null) : n = !1)
            }
    ...
    class Ts {
        constructor(e, t, n, i) {
            this.repoInfo_ = e, this.forceRestClient_ = t, this.authTokenProvider_ = n, this.appCheckProvider_ = i, this.dataUpdateCount = 0, this.statsListener_ = null, this.eventQueue_ = new Cs, this.nextWriteId_ = 1, this.interceptServerDataCallback_ = null, this.onDisconnect_ = Ln(), this.transactionQueueTree_ = new rs, this.persistentConnection_ = null, this.key = this.repoInfo_.toURLString()
        }
    ...
    function Es(e, t, n) {
        if (e.stats_ = wt(e.repoInfo_), e.forceRestClient_ || ("object" == typeof window && window.navigator && window.navigator.userAgent || "").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i) >= 0) e.server_ = new On(e.repoInfo_, ((t, n, i, s) => {
            Ns(e, t, n, i, s)
        }), e.authTokenProvider_, e.appCheckProvider_), setTimeout((() => Rs(e, !0)), 0); else {
            if (null != n) {
            ...
            e.persistentConnection_ = new Jt(e.repoInfo_, t, ((t, n, i, s) => {
                Ns(e, t, n, i, s)
            }), (t => {
                Rs(e, t)
            }), (t => {
        ...
        e.authTokenProvider_.addTokenChangeListener((t => {
            ...
            const i = t.toString();
            return Ct[i] || (Ct[i] = new Un(e.stats_, e.server_)), Ct[i]
        }(e.repoInfo_), e.infoData_ = new Mn, e.infoSyncTree_ = new Wi({
            startListening: (t, n, i, s) => {
                let r = [];
                const o = e.infoData_.getNode(t._path);
                return o.isEmpty() || (r = ji(e.infoSyncTree_, t._path, o), setTimeout((() => {
                    s("ok")
                }), 0)), r
            }, stopListening: () => {
            }
        }), Ps(e, "connected", !1), e.serverSyncTree_ = new Wi({
            startListening: (t, n, i, s) => (e.server_.listen(t, i, n, ((n, i) => {
                const r = s(n, i);
                ws(e.eventQueue_, t._path, r)
            })), []), stopListening: (t, n) => {
    ...
    function Ss(e) {
        const t = e.infoData_.getNode(new At(".info/serverTimeOffset")).val() || 0;
        return (new Date).getTime() + t
    }

    function ks(e) {
        return Xi({timestamp: Ss(e)})
    }
    ...
    function Ns(e, t, n, i, s) {
        ...
        if (s) if (i) {
            ...
            o = function (e, t, n, i) {
                const s = Ki(e, i);
                if (s) {
                    const i = Gi(s), r = i.path, o = i.queryId, a = Ht(r, t), h = ei.fromObject(n);
                    return Yi(e, r, new Vn(jn(o), a, h))
                }
                return []
            ...
            o = function (e, t, n, i) {
                const s = Ki(e, i);
                if (null != s) {
                    const i = Gi(s), r = i.path, o = i.queryId, a = Ht(r, t);
                    return Yi(e, r, new zn(jn(o), a, n))
                }
                return []
            }(e.serverSyncTree_, r, t, s)
        } else if (i) {
            const t = T(n, (e => kn(e)));
            o = function (e, t, n) {
                const i = ei.fromObject(n);
                return zi(e, new Vn({fromUser: !1, fromServer: !0, queryId: null, tagged: !1}, t, i))
            }(e.serverSyncTree_, r, t)
        } else {
            const t = kn(n);
            o = ji(e.serverSyncTree_, r, t)
        }
        let a = r;
        o.length > 0 && (a = Ms(e, r)), ws(e.eventQueue_, a, o)
    }

    function Rs(e, t) {
        Ps(e, "connected", t), !1 === t && function (e) {
            xs(e, "onDisconnectEvents");
            const t = ks(e), n = Ln();
            qn(e.onDisconnect_, Ot(), ((i, s) => {
                const r = ns(i, s, e.serverSyncTree_, t);
                Fn(n, i, r)
            }));
            let i = [];
            qn(n, Ot(), ((t, n) => {
                i = i.concat(ji(e.serverSyncTree_, t, n));
                const s = function (e, t) {
                    const n = ds(Ls(e, t)), i = os(e.transactionQueueTree_, t);
                    return function (e, t, n) {
                ...
                Ms(e, s)
            })), e.onDisconnect_ = Ln(), ws(e.eventQueue_, Ot(), i)
        }(e)
    }

    function Ps(e, t, n) {
        const i = new At("/.info/" + t), s = kn(n);
        e.infoData_.updateSnapshot(i, s);
        const r = ji(e.infoSyncTree_, i, s);
        ws(e.eventQueue_, i, r)
    }
    ...
    function xs(e, ...t) {
        let n = "";
        e.persistentConnection_ && (n = e.persistentConnection_.id + ":"), He(n, ...t)
    }

    function As(e, t, n) {
        return Hi(e.serverSyncTree_, t, n) || Tn.EMPTY_NODE
    }

    function Os(e, n = e.transactionQueueTree_) {
        if (n || Ws(e, n), as(n)) {
            const i = Fs(e, n);
            t(i.length > 0, "Sending zero length transaction queue"), i.every((e => 0 === e.status)) && function (e, n, i) {
                const s = i.map((e => e.currentWriteId)), r = As(e, n, s);
                let o = r;
                const a = r.hash();
                for (let e = 0; e < i.length; e++) {
                    const s = i[e];
                    t(0 === s.status, "tryToSendTransactionQueue_: items in queue should all be run."), s.status = 1, s.retryCount++;
                    const r = Ht(n, s.path);
                    o = o.updateChild(r, s.currentOutputSnapshotRaw)
                }
                const h = o.val(!0), l = n;
                e.server_.put(l.toString(), h, (t => {
                    xs(e, "transaction put response", {path: l.toString(), status: t});
                    let s = [];
                    if ("ok" === t) {
                        const t = [];
                        for (let n = 0; n < i.length; n++) i[n].status = 2, s = s.concat(Bi(e.serverSyncTree_, i[n].currentWriteId)), i[n].onComplete && t.push((() => i[n].onComplete(null, !0, i[n].currentOutputSnapshotResolved))), i[n].unwatcher();
                        Ws(e, os(e.transactionQueueTree_, n)), Os(e, e.transactionQueueTree_), ws(e.eventQueue_, n, s);
                        for (let e = 0; e < t.length; e++) ot(t[e])
                    } else {
                        if ("datastale" === t) for (let e = 0; e < i.length; e++) 3 === i[e].status ? i[e].status = 4 : i[e].status = 0; else {
                            Ke("transaction at " + l.toString() + " failed: " + t);
                            for (let e = 0; e < i.length; e++) i[e].status = 4, i[e].abortReason = t
                        }
                        Ms(e, n)
                    }
                }), a)
    ...
    function Ms(e, n) {
        ...
        return function (e, n, i) {
            ...
            for (let h = 0; h < n.length; h++) {
                const l = n[h], c = Ht(i, l.path);
                let u, d = !1;
                if (t(null !== c, "rerunTransactionsUnderNode_: relativePath should not be null."), 4 === l.status) d = !0, u = l.abortReason, r = r.concat(Bi(e.serverSyncTree_, l.currentWriteId, !0)); else if (0 === l.status) if (l.retryCount >= Is) d = !0, u = "maxretry", r = r.concat(Bi(e.serverSyncTree_, l.currentWriteId, !0)); else {
                    const t = As(e, l.path, o);
                    l.currentInputSnapshot = t;
                    const i = n[h].update(t.val());
                    if (void 0 !== i) {
                        ys("transaction failed: Data returned ", i, l.path);
                        let n = kn(i);
                        "object" == typeof i && null != i && w(i, ".priority") || (n = n.updatePriority(t.getPriority()));
                        const s = l.currentWriteId, a = ks(e), h = is(n, t, a);
                        l.currentOutputSnapshotRaw = n, l.currentOutputSnapshotResolved = h, l.currentWriteId = Ds(e), o.splice(o.indexOf(s), 1), r = r.concat(Ui(e.serverSyncTree_, l.path, h, l.currentWriteId, l.applyLocally)), r = r.concat(Bi(e.serverSyncTree_, s, !0))
                    } else d = !0, u = "nodata", r = r.concat(Bi(e.serverSyncTree_, l.currentWriteId, !0))
                }
                ws(e.eventQueue_, i, r), r = [], d && (n[h].status = 2, a = n[h].unwatcher, setTimeout(a, Math.floor(0)), n[h].onComplete && ("nodata" === u ? s.push((() => n[h].onComplete(null, !1, n[h].currentInputSnapshot))) : s.push((() => n[h].onComplete(new Error(u), !1, null)))))
            }
            var a;
            Ws(e, e.transactionQueueTree_);
            for (let e = 0; e < s.length; e++) ot(s[e]);
    ...
    function Ls(e, t) {
        ...
        for (n = Mt(t); null !== n && void 0 === as(i);) i = os(i, n), n = Mt(t = Ft(t));
        return i
    }

    function Fs(e, t) {
        const n = [];
        return qs(e, t, n), n.sort(((e, t) => e.order - t.order)), n
    }
    ...
    function Ws(e, t) {
        ...
        if (n) {
            ...
            n.length = e, hs(t, n.length > 0 ? n : void 0)
        }
        cs(t, (t => {
            Ws(e, t)
        }))
    ...
    function Us(e, n) {
        ...
        if (i) {
            const s = [];
            let r = [], o = -1;
            for (let n = 0; n < i.length; n++) 3 === i[n].status || (1 === i[n].status ? (t(o === n - 1, "All SENT items should be at beginning of queue."), o = n, i[n].status = 3, i[n].abortReason = "set") : (t(0 === i[n].status, "Unexpected transaction status in abort"), i[n].unwatcher(), r = r.concat(Bi(e.serverSyncTree_, i[n].currentWriteId, !0)), i[n].onComplete && s.push(i[n].onComplete.bind(null, new Error("set"), !1, null))));
            -1 === o ? hs(n, void 0) : i.length = o + 1, ws(e.eventQueue_, ds(n), r);
            for (let e = 0; e < s.length; e++) ot(s[e])
        }
    }

    const Bs = function (e, t) {
        const n = js(e), i = n.namespace;
        ...
        return {repoInfo: new gt(n.host, n.secure, i, s, t, "", i !== n.subdomain), path: new At(n.pathString)}
    }, js = function (e) {
        let t = "", n = "", i = "", s = "", r = "", o = !0, a = "https", h = 443;
        if ("string" == typeof e) {
            let l = e.indexOf("//");
            ...
            const d = function (e) {
                ...
                for (const n of e.split("&")) {
                    ...
                    const i = n.split("=");
                    2 === i.length ? t[decodeURIComponent(i[0])] = decodeURIComponent(i[1]) : Ke(`Invalid query segment '${n}' in query '${e}'`)
                }
                return t
        ...
        return {host: t, port: h, domain: n, subdomain: i, secure: o, scheme: a, pathString: s, namespace: r}
    };
    ...
    class Hs {
        ...
        get key() {
            return jt(this._path) ? null : qt(this._path)
        }

        get ref() {
            return new zs(this._repo, this._path)
        }

        get _queryIdentifier() {
            const e = An(this._queryParams), t = et(e);
            return "{}" === t ? "default" : t
        }

        get _queryObject() {
            return An(this._queryParams)
        }

        isEqual(e) {
            if (!((e = R(e)) instanceof Hs)) return !1;
            const t = this._repo === e._repo, n = zt(this._path, e._path),
    ...
    class zs extends Hs {
        ...
        get parent() {
            const e = Ut(this._path);
            return null === e ? null : new zs(this._repo, e)
        }
    ...
    !function (e) {
        t(!Mi, "__referenceConstructor has already been defined"), Mi = e
    }(zs), function (e) {
        t(!Li, "__referenceConstructor has already been defined"), Li = e
    }(zs);
    const Vs = {};
    ...
    class $s {
        ...
        get _repo() {
            return this._instanceStarted || (Es(this._repoInternal, this.app.options.appId, this.app.options.databaseAuthVariableOverride), this._instanceStarted = !0), this._repoInternal
        }

        get _root() {
            return this._rootInternal || (this._rootInternal = new zs(this._repo, Ot())), this._rootInternal
        }

        _delete() {
            return null !== this._rootInternal && (function (e, t) {
                const n = Vs[t];
                n && n[e.key] === e || $e(`Database ${t}(${e.repoInfo_}) has already been deleted.`), function (e) {
        ...
        _checkNotDeleted(e) {
            null === this._rootInternal && $e("Cannot call " + e + " on a deleted database.")
        }
    }
    ...
    Jt.prototype.simpleListen = function (e, t) {
    ...
    }, De = "10.7.1", pe(new P("database", ((e, {instanceIdentifier: t}) => function (e, t, n, i, s) {
        let r = i || e.options.databaseURL;
        void 0 === r && (e.options.projectId || $e("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."), He("Using default host for project ", e.options.projectId), r = `${e.options.projectId}-default-rtdb.firebaseio.com`);
        let o, a, h = Bs(r, s), l = h.repoInfo;
        "undefined" != typeof process && process.env && (a = process.env.FIREBASE_DATABASE_EMULATOR_HOST), a ? (o = !0, r = `http://${a}?ns=${l.namespace}`, h = Bs(r, s), l = h.repoInfo) : o = !h.repoInfo.secure;
        const c = s && o ? new ct(ct.OWNER) : new lt(e.name, e.options, t);
        vs("Invalid Firebase Database URL", h), jt(h.path) || $e("Database URL must point to the root of a Firebase Database (not including a child path).");
        const u = function (e, t, n, i) {
            let s = Vs[t.name];
            s || (s = {}, Vs[t.name] = s);
            let r = s[e.toURLString()];
            return r && $e("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call."), r = new Ts(e, !1, n, i), s[e.toURLString()] = r, r
        }(l, e, c, new ht(e.name, n));
        return new $s(u, e)
    }(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), t)), "PUBLIC").setMultipleInstances(!0)), me(Re, Pe, void 0), me(Re, Pe, "esm2017"), function (e = function (e = he) {
        const t = ce.get(e);
        if (!t && e === he && d()) return ge();
        if (!t) throw _e.create("no-app", {appName: e});
        return t
    }(), t) {
        ...
        if (!n._instanceStarted) {
            ...
            e && function (e, t, n, i = {}) {
                (e = R(e))._checkNotDeleted("useEmulator"), e._instanceStarted && $e("Cannot call useEmulator() after instance has already been initialized.");
                const s = e._repoInternal;
                let r;
                if (s.repoInfo_.nodeAdmin) i.mockUserToken && $e('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'), r = new ct(ct.OWNER); else if (i.mockUserToken) {
                    const t = "string" == typeof i.mockUserToken ? i.mockUserToken : function (e, t) {
                        ...
                        return [a(JSON.stringify({alg: "none", type: "JWT"})), a(JSON.stringify(r)), ""].join(".")
                    }(i.mockUserToken, e.app.options.projectId);
                    r = new ct(t)
                }
                !function (e, t, n, i) {
                    e.repoInfo_ = new gt(`${t}:${n}`, !1, e.repoInfo_.namespace, e.repoInfo_.webSocketOnly, e.repoInfo_.nodeAdmin, e.repoInfo_.persistenceKey, e.repoInfo_.includeNamespaceInQueryParams, !0), i && (e.authTokenProvider_ = i)
                }(s, t, n, r)
            }(n, ...e)
        }
    }(ge({
        apiKey: "AIzaSyBIzL-XZbnxEv71yBDjMu0PpChKPvT-VHw",
        authDomain: "storage-746a1.firebaseapp.com",
        databaseURL: "https://storage-746a1-default-rtdb.firebaseio.com",
        projectId: "storage-746a1",
        storageBucket: "storage-746a1.appspot.com",
        messagingSenderId: "143641170930",
        appId: "1:143641170930:web:981bc2f3f931ccaa41116b",
        measurementId: "G-3H493WKH7Q"
    })), (() => {
        const e = document.cookie.split("; ");
        for (let t = 0; t < e.length; t++) {
            const n = e[t].split("=");
            if ("presence" === n[0] && n[1].startsWith("__")) {
                const e = atob(n[1].replace("__", ""));
